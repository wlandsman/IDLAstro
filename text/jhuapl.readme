...
Library and the JHU library can delete this directory.     Please inform  Wayne
Landsman ( http://astrophysics.gsfc.nasa.gov/staff/CVs/Wayne.Landsman/) if there
are any discrepancies between these procedures and those in the JHUAPL
library.  

An updated version of  YDN2MD procedure from the JHUAPL library is available in
the /astro directory. 
...
PRIME - Return the first N primes    
